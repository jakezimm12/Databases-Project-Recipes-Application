...
export default function ReviewerPage() {
  const [numRecipe, setNumRecipe] = React.useState(100);
  ...
  const refresh = () => {
  fetch(`http://${config.server_host}:${config.server_port}/top_reviewers/recipe?` +
        `numRecipe=${numRecipe}` + 
        `&tag=${tag}` +
      ...
      <CssBaseline />
          ...
          <Container maxWidth="lg">
            ...
            <Typography component="p" variant="h4" gutterBottom>
              Recipes Rated by Top Reviewers
            </Typography>

            <Typography component="p" variant="body1" gutterBottom>
              Do you wonder what recipes are rated high by users who have reviewed a lot of recepies?
              Well, here they are:
            </Typography>
              ...
              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                ...
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="right">Top Reviewers Rating</TableCell>
                    <TableCell align="right">Top Reviewers Number</TableCell>
                  </TableRow>
                </TableHead>
